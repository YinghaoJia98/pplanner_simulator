...
Source code from other [developers](https://github.com/nilseuropa/realsense_ros_gazebo.git).
## RealSense T265 ##
...
### Usage ###
```xml
<xacro:include filename="$(find realsense_simulator)/xacro/tracker.xacro"/>
...
### Usage ###
```xml
<xacro:include filename="$(find realsense_simulator)/xacro/depthcam.xacro"/>
